...
import com.evan.lib.view.load.FloatProperty;
import com.evan.lib.view.load.IntProperty;
...
public abstract class Sprite extends Drawable implements
    ...
    @Override
    public void start() {
        if (SpinAnimationUtils.isStarted(animator)) {
            return;
        }
        ...
        SpinAnimationUtils.start(animator);
        invalidateSelf();
    }
    ...
    public boolean isRunning() {
        return SpinAnimationUtils.isRunning(animator);
    }
