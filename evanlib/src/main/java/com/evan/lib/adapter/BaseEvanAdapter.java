...
public abstract class BaseEvanAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    protected static final String TAG = BaseEvanAdapter.class.getSimpleName();
     ...
     * 设置页面的跳转
     */
    public void startActivity(Activity activity, Class<?> toClass, Map<String, String> param,
        boolean isFinish) {
     ...
     */
    public BaseEvanAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public BaseEvanAdapter(@Nullable List<T> data) {
        this(0, data);
    }

    public BaseEvanAdapter(@LayoutRes int layoutResId) {
    ...
    /**
     * use data to replace all item in mData. this method is different {@link #(List)}, it doesn't change the mData reference
     *
    ...
    /**
     * if asFlow is true, footer/header will arrange like normal item view. only works when use {@link GridLayoutManager},and it will ignore span size.
     */
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    getOnItemClickListener().onItemClick(BaseEvanAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getOnItemLongClickListener().onItemLongClick(BaseEvanAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
    }
    ...
    /**
     * Add header view to mHeaderLayout and set header view position in mHeaderLayout. When index = -1 or index >= child count in mHeaderLayout, the effect of this method is the same as that of {@link #addHeaderView(View)}.
     *
    ...
    /**
     * Add footer view to mFooterLayout and set footer view position in mFooterLayout. When index = -1 or index >= child count in mFooterLayout, the effect of this method is the same as that of {@link #addFooterView(View)}.
     *
     * @param index the position in mFooterLayout of this footer. When index = -1 or index >= child count in mFooterLayout, the effect of this method is the same as that of {@link #addFooterView(View)}.
     */
    ...
    /**
     * remove header view from mHeaderLayout. When the child count of mHeaderLayout is 0, mHeaderLayout will be set to null.
     */
    ...
    /**
     * set emptyView show if adapter is empty and want to show headview and footview Call before {@link RecyclerView#setAdapter(RecyclerView.Adapter)}
     */
     ...
     * @param parent Optional view to be the parent of the generated hierarchy or else simply an object that provides a set of LayoutParams values for root of the returned hierarchy
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(BaseEvanAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(BaseEvanAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseEvanAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseEvanAdapter adapter, View view, int position);
    }
